...
$(function () {
    ...
    $('#stop_btn').click(function () {
        ...
        $('#tempo').text(TEMPO_EXECUCAO + ' Segundos')
...
function initData() {
    ...
    TAMANHO_POPULACAO = parseFloat($('#tamanhopop').val());

    ELITE_RATE = 0.3;

    PROBABILIDADE_CRUZAMENTO = parseFloat($('#taxacruzamento').val());

    PROBABILIDADE_MUTACAO  = parseFloat($('#taxamutacao').val());
